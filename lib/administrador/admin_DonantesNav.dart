...
import 'package:lapuerta2/administrador/Admin_Donantes_feed/Admin_Donantesfeed.dart';
import 'package:lapuerta2/administrador/Admin_Donantes_feed/Admin_donors_list.dart';
...
class AdminDonantesNav extends StatefulWidget{
  const AdminDonantesNav({super.key});
  @override
  State<AdminDonantesNav> createState() => _AdminDonantesNavState();
}

class _AdminDonantesNavState extends State<AdminDonantesNav> with TickerProviderStateMixin {
      ...
      onGenerateRoute: (RouteSettings settings) {
        return MaterialPageRoute(
          ...
          builder: (BuildContext context) {
            ...
            if (settings.name == '/AdminDonantesList') {
              //details page
              return AdminDonorslist();
            }
            


            //main Page
            return AdminDonantesfeed();
          }
        );
      },
    );
