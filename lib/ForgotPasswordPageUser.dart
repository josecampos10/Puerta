...
class ForgotPasswordPageUser extends StatefulWidget {
  const ForgotPasswordPageUser({super.key});

  @override
  State<ForgotPasswordPageUser> createState() => _ForgotPasswordPageUserState();
}

class _ForgotPasswordPageUserState extends State<ForgotPasswordPageUser> {
  String? errorMessage = '';
  bool isLogin = true;
