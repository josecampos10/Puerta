...
class ProfeCorte1 extends StatefulWidget {
  const ProfeCorte1({super.key});
  @override
  State<ProfeCorte1> createState() => _ProfeCorte1State();
}

class _ProfeCorte1State extends State<ProfeCorte1> {
  final currentUser = FirebaseAuth.instance.currentUser!;
  final usuario = FirebaseFirestore.instance.collection('users').doc().snapshots();

  CollectionReference users = FirebaseFirestore.instance.collection('postsCorte1');
  final controller = TextEditingController();

  final streaming = FirebaseFirestore.instance
      .collection('postsCorte1')
  ...
  Future<List<String>> _uploadImagesWithProgress(String postId) async {
    ...
    for (int i = 0; i < _selectedImages.length; i++) {
      try {
        ...
        final ref = storage.ref().child('class_media/Corte1/$postId/$fileName');
  ...
  void _syncProgressList() {
    if (_uploadProgress.length < _selectedImages.length) {
      _uploadProgress.addAll(
        List<double>.filled(_selectedImages.length - _uploadProgress.length, 0.0),
      );
  ...
  Widget build(BuildContext context) {
    ...
    final composerH = size.height * 0.06; // altura de la barra de input
    final previewH = size.height * 0.10; // reservado (no usado aquí), por consistencia visual
            ...
            Positioned.fill(
              child: Container(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      // ---- Cabecera de clase (0.10 alto) con acciones superpuestas ----
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          IconButton(
                                            onPressed: () => Navigator.pushNamed(context, '/profeCorte1_files'),
                                            icon: Icon(Icons.folder, color: Colors.white, size: size.height * 0.03),
                                          ),
                                          IconButton(
                                            onPressed: () => Navigator.pushNamed(context, '/profeCorte1_students'),
                              ...
                              child: Align(
                                ...
                                child: MasonryGridView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    // debug
                                    debugPrint('Post ${doc.id} -> images: ${images.length}');
                ...
                Navigator.push(
                  ...
                  PageRouteBuilder(
                    ...
                    pageBuilder: (_, __, ___) => ImageDetallesHome(
                      images: images,
                      initialIndex: 0,
                      documentSnapshot: doc, // 👈 pasa el doc si tu detalle lo usa
                    ),
                  ),
                );
              },
              child: Hero(
                tag: 'profe_corte1_post_${doc.id}_img_0',
                child: Image.network(
                  images.first,
                  fit: BoxFit.cover,
                ),
              ...
              itemBuilder: (_, idx) {
                ...
                return Padding(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                        ...
                        PageRouteBuilder(
                          ...
                          pageBuilder: (_, __, ___) => ImageDetallesHome(
                            images: images,
                            initialIndex: idx, // 👈 abre en la imagen tocada
                    ...
                    child: Hero(
                      tag: 'profe_corte1_post_${doc.id}_img_$idx',
                      child: Image.network(
                        url,
                        fit: BoxFit.cover,
                      ),
                                                                  ...
                                                                  onPressed: () async {
                                                                    ...
                                                                    try {
                                                                      ...
                                                                      await FirebaseFirestore.instance
                                                                        ...
                                                                        'storagePath': 'class_media/Corte1/$postId/',
                                                                        'Image': snapUser.data.toString(),
