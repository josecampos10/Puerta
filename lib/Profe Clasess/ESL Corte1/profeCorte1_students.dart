...
class ProfeCorte1students extends StatefulWidget {
  const ProfeCorte1students({super.key});
  @override
  State<ProfeCorte1students> createState() => _ProfeCorte1studentsState();
}

class _ProfeCorte1studentsState extends State<ProfeCorte1students> {
  ...
  Future uploadFile() async {
    final path = 'Corte1files/${pickedFile!.name}';
  ...
  void initState() {
    super.initState();
    futureFiles = FirebaseStorage.instance.ref('/Corte1files').listAll();
    getProfilePicture();
    futureUserDoc =
        FirebaseFirestore.instance.collection('clases').doc('Corte y Confección').get();
    futureUsers = FirebaseFirestore.instance
        .collection('users')
        .orderBy('name', descending: false)
        .get();
...
final filtered = snap.where((d) {
  ...
  final ciudadania = data['Corte1']?.toString().trim();
