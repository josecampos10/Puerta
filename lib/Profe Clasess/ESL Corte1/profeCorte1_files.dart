...
class ProfeCorte1files extends StatefulWidget {
  const ProfeCorte1files({super.key});
  @override
  State<ProfeCorte1files> createState() => _ProfeCorte1filesState();
}

class _ProfeCorte1filesState extends State<ProfeCorte1files> {
  ...
  Future<void> uploadFile() async {
    ...
    final folderRef = FirebaseStorage.instance.ref().child('Corte1files');
    ...
    final path = 'Corte1files/$finalName';
  ...
  Future<List<Reference>> obtenerArchivosOrdenados() async {
    final result = await FirebaseStorage.instance.ref('/Corte1files').listAll();
