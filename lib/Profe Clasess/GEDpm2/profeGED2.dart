          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: TextButton(
                    onPressed: () =>
                        Navigator.pushNamed(context, '/profeGEDpm2_files'),
                    child: Row(
              ...
              Container(
                ...
                child: TextButton(
                    onPressed: () =>
                        Navigator.pushNamed(context, '/profeGEDpm2_students'),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        SizedBox(
                                                                    ...
                                                                    return AlertDialog(
                                                                      ...
                                                                      actions: [
                                                                        TextButton(
                                                                            onPressed:
                                                                                () {
                                                                              FirebaseFirestore.instance.collection('postsGED2').doc(snapshot.data!.docs[index].id).delete();
                                                                              FirebaseFirestore.instance.collection('users').doc(currentUser.email).collection('postsGEDpm2_State').doc('State').set({
                                                                                'lastpost': ''
                                                                              });
