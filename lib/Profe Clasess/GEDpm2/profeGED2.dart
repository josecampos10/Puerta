...
class Profegedpm2 extends StatefulWidget {
  const Profegedpm2({super.key});
  @override
  State<Profegedpm2> createState() => _Profegedpm2State();
}

class _Profegedpm2State extends State<Profegedpm2> {
  final currentUser = FirebaseAuth.instance.currentUser!;
  final usuario = FirebaseFirestore.instance.collection('users').doc().snapshots();

  CollectionReference users = FirebaseFirestore.instance.collection('postsGED2');
  final controller = TextEditingController();

  final streaming = FirebaseFirestore.instance
      .collection('postsGED2')
  ...
  Future<List<String>> _uploadImagesWithProgress(String postId) async {
    ...
    for (int i = 0; i < _selectedImages.length; i++) {
      try {
        ...
        final ref = storage.ref().child('class_media/GEDpm2/$postId/$fileName');
  ...
  void initState() {
    ...
    getProfilePicture();
    futureUserDoc = FirebaseFirestore.instance.collection('clases').doc('GEDpm2').get();
  }
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          IconButton(
                                            onPressed: () => Navigator.pushNamed(context, '/profeGEDpm2_files'),
                                            icon: Icon(Icons.folder, color: Colors.white, size: size.height * 0.03),
                                          ),
                                          IconButton(
                                            onPressed: () => Navigator.pushNamed(context, '/profeGEDpm2_students'),
                                                                  ...
                                                                  onPressed: () async {
                                                                    ...
                                                                    try {
                                                                      ...
                                                                      await FirebaseFirestore.instance
                                                                        ...
                                                                        'storagePath': 'class_media/GEDpm2/$postId/',
