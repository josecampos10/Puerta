...
class Profegedstudentspm2 extends StatefulWidget {
  const Profegedstudentspm2({super.key});
  @override
  State<Profegedstudentspm2> createState() => _Profegedstudentspm2State();
}

class _Profegedstudentspm2State extends State<Profegedstudentspm2> {
  ...
  Future uploadFile() async {
    final path = 'GEDfiles2/${pickedFile!.name}';
  ...
  void initState() {
    super.initState();
    futureFiles = FirebaseStorage.instance.ref('/GEDfiles2').listAll();
    getProfilePicture();
    futureUserDoc =
        FirebaseFirestore.instance.collection('clases').doc('GEDpm2').get();
    futureUsers = FirebaseFirestore.instance
        .collection('users')
        .orderBy('name', descending: false)
        .get();
...
final filtered = snap.where((d) {
  ...
  final ciudadania = data['GEDpm2']?.toString().trim();
