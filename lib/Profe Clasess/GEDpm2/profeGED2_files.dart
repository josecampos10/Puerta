...
class Profegedfilespm2 extends StatefulWidget {
  const Profegedfilespm2({super.key});
  @override
  State<Profegedfilespm2> createState() => _Profegedfilespm2State();
}

class _Profegedfilespm2State extends State<Profegedfilespm2> {
  ...
  Future<void> uploadFile() async {
    ...
    final folderRef = FirebaseStorage.instance.ref().child('GEDfiles2');
    ...
    final path = 'GEDfiles2/$finalName';
  ...
  Future<List<Reference>> obtenerArchivosOrdenados() async {
    final result = await FirebaseStorage.instance.ref('/GEDfiles2').listAll();
