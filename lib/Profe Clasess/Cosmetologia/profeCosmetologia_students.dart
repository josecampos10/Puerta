...
class Profecosmetologiastudents extends StatefulWidget {
  ...
  @override
  State<Profecosmetologiastudents> createState() => _ProfecosmetologiastudentsState();
}

class _ProfecosmetologiastudentsState extends State<Profecosmetologiastudents> {
  ...
  Future uploadFile() async {
    final path = 'Cosmetologiafiles/${pickedFile!.name}';
  ...
  void initState() {
    super.initState();
    futureFiles = FirebaseStorage.instance.ref('/Cosmetologiafiles').listAll();
    getProfilePicture();
    futureUserDoc =
...
final filtered = snap.where((d) {
  ...
  final ciudadania = data['cosmetologia']?.toString().trim();
