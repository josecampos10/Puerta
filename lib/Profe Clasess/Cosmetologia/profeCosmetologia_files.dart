...
class _ProfeCosmetologiafilesState extends State<ProfeCosmetologiafiles> {
  final currentUser = FirebaseAuth.instance.currentUser!;
  CollectionReference users = FirebaseFirestore.instance.collection('postsCosmetolgia');
  ...
  Future<void> uploadFile() async {
    ...
    final folderRef = FirebaseStorage.instance.ref().child('Cosmetologiafiles');
    ...
    final path = 'Cosmetologiafiles/$finalName';
  ...
  Future<List<Reference>> obtenerArchivosOrdenados() async {
    final result = await FirebaseStorage.instance.ref('/Cosmetologiafiles').listAll();
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      setState(
                                                                        ...
                                                                        FirebaseStorage
                                                                            .instance
                                                                            .ref()
                                                                            .child('Cosmetologiafiles/${file.name}')
                                                                            .delete();
                                                                      });
