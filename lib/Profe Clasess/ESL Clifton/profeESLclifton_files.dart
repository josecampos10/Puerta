...
class Profeeslfilesclifton extends StatefulWidget {
  const Profeeslfilesclifton({super.key});
  @override
  State<Profeeslfilesclifton> createState() => _ProfeeslfilescliftonState();
}

class _ProfeeslfilescliftonState extends State<Profeeslfilesclifton> {
  ...
  Future<void> uploadFile() async {
    ...
    final folderRef = FirebaseStorage.instance.ref().child('ESLcliftonfiles');
    ...
    final path = 'ESLcliftonfiles/$finalName';
  ...
  Future<List<Reference>> obtenerArchivosOrdenados() async {
    final result = await FirebaseStorage.instance.ref('/ESLcliftonfiles').listAll();
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      setState(
                                                                        ...
                                                                        FirebaseStorage
                                                                            .instance
                                                                            .ref()
                                                                            .child('ESLcliftonfiles/${file.name}')
                                                                            .delete();
                                                                      });
