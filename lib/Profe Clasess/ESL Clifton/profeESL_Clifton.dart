...
class Profeeslclifton extends StatefulWidget {
  const Profeeslclifton({super.key});
  @override
  State<Profeeslclifton> createState() => _ProfeeslcliftonState();
}

class _ProfeeslcliftonState extends State<Profeeslclifton> {
  ...
  final CollectionReference users =
      FirebaseFirestore.instance.collection('postsESLclifton');

  final TextEditingController controller = TextEditingController();

  // Stream del feed
  final Stream<QuerySnapshot> streaming = FirebaseFirestore.instance
      .collection('postsESLclifton')
  ...
  Future<List<String>> _uploadImagesWithProgress(String postId) async {
    ...
    for (int i = 0; i < _selectedImages.length; i++) {
      try {
        ...
        final ref =
            storage.ref().child('class_media/ESLclifton/$postId/$fileName');
  ...
  Widget build(BuildContext context) {
    ...
    final previewH = size.height * 0.10; // preview flotante
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        bottomOpacity: 0.0,
        toolbarHeight: size.height * 0.09, // igual que Corte2
            ...
            Positioned.fill(
              child: Container(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      // ---- Cabecera de clase (estilo Corte2) ----
                      ...
                      StreamBuilder<QuerySnapshot>(
                        ...
                        builder: (BuildContext context,
                            AsyncSnapshot<QuerySnapshot> feedSnapshot) {
                          ...
                          if (!feedSnapshot.hasData ||
                              feedSnapshot.data!.docs.isEmpty) {
                          ...
                          final snap = feedSnapshot.data!.docs;
                          return RefreshIndicator(
                            elevation: 0,
                            color: Theme.of(context).colorScheme.tertiary,
                            backgroundColor:
                                                ...
                                                child: Column(
                                                  children: [
                                                    Row(
                                                      children: [
                                                        CircleAvatar(
                                                          backgroundImage: (dataMap['Image'] != null &&
                                                                    ...
                                                                    TextButton(
                                                                      onPressed:
                                                                        ...
                                                                        FirebaseFirestore
                                                                            .instance
                                                                            .collection('postsESLclifton')
                                                                            .doc(feedSnapshot.data!.docs[index].id)
                                                                            .delete();
                                                                        FirebaseFirestore
                                                                            .instance
                                                                            .collection('users')
                                                                            .doc(currentUser.email)
                                                                            .collection('postsESLclifton_State')
                                                                            .doc('State')
                                                                            .set({'lastpost': ''});
                                                                ...
                                                                TextButton(
                                                                  onPressed:
                                                                    ...
                                                                    try {
                                                                      ...
                                                                      // ✅ Estado global (todos ven el ícono de nuevo post)
                                                                      await FirebaseFirestore
                                                                          .instance
                                                                          .collection(
                                                                              'postsState')
