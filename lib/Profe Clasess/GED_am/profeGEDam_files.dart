...
class Profegedfilesam extends StatefulWidget {
  const Profegedfilesam({super.key});
  @override
  State<Profegedfilesam> createState() => _ProfegedfilesamState();
}

class _ProfegedfilesamState extends State<Profegedfilesam> {
  ...
  Future<void> uploadFile() async {
    ...
    final folderRef = FirebaseStorage.instance.ref().child('GEDfilesam');
    ...
    final path = 'GEDfilesam/$finalName';
  ...
  Future<List<Reference>> obtenerArchivosOrdenados() async {
    final result = await FirebaseStorage.instance.ref('/GEDfilesam').listAll();
