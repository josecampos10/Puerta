...
class Profegedam extends StatefulWidget {
  const Profegedam({super.key});
  @override
  State<Profegedam> createState() => _ProfegedamState();
}

class _ProfegedamState extends State<Profegedam> {
  ...
  Future<List<String>> _uploadImagesWithProgress(String postId) async {
    ...
    for (int i = 0; i < _selectedImages.length; i++) {
      try {
        ...
        final ref = storage.ref().child('class_media/GEDam/$postId/$fileName');
  ...
  void initState() {
    ...
    getProfilePicture();
    futureUserDoc =
        FirebaseFirestore.instance.collection('clases').doc('GEDam').get();
  }
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          IconButton(
                                            onPressed: () => Navigator.pushNamed(context, '/profeGEDam_files'),
                                            icon: Icon(Icons.folder, color: Colors.white, size: size.height * 0.03),
                                          ),
                                          IconButton(
                                            onPressed: () => Navigator.pushNamed(context, '/profeGEDam_students'),
                                                                  ...
                                                                  onPressed: () async {
                                                                    ...
                                                                    try {
                                                                      ...
                                                                      await FirebaseFirestore.instance
                                                                        ...
                                                                        'storagePath': 'class_media/GEDam/$postId/',
