...
class Profegedstudentsam extends StatefulWidget {
  const Profegedstudentsam({super.key});
  @override
  State<Profegedstudentsam> createState() => _ProfegedstudentsamState();
}

class _ProfegedstudentsamState extends State<Profegedstudentsam> {
  ...
  Future uploadFile() async {
    final path = 'GEDfilesam/${pickedFile!.name}';
  ...
  void initState() {
    super.initState();
    futureFiles = FirebaseStorage.instance.ref('/GEDfilesam').listAll();
    getProfilePicture();
    futureUserDoc =
...
final filtered = snap.where((d) {
  ...
  final ciudadania = data['GEDam']?.toString().trim();
