...
class Profevoluntariosfiles extends StatefulWidget {
  const Profevoluntariosfiles({super.key});
  @override
  State<Profevoluntariosfiles> createState() => _ProfevoluntariosfilesState();
}

class _ProfevoluntariosfilesState extends State<Profevoluntariosfiles> {
  ...
  Future<void> uploadFile() async {
    ...
    final folderRef = FirebaseStorage.instance.ref().child('Volunteersfiles');
    ...
    final path = 'Volunteersfiles/$finalName';
  ...
  Future<List<Reference>> obtenerArchivosOrdenados() async {
    final result = await FirebaseStorage.instance.ref('/Volunteersfiles').listAll();
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      setState(
                                                                        ...
                                                                        FirebaseStorage
                                                                            .instance
                                                                            .ref()
                                                                            .child('Volunteersfiles/${file.name}')
                                                                            .delete();
                                                                      });
