...
class ProfeVoluntariosStudents extends StatefulWidget {
  const ProfeVoluntariosStudents({super.key});
  @override
  State<ProfeVoluntariosStudents> createState() => _ProfeVoluntariosStudentsState();
}

class _ProfeVoluntariosStudentsState extends State<ProfeVoluntariosStudents> {
  ...
  Future uploadFile() async {
    final path = 'Volunteersfiles/${pickedFile!.name}';
  ...
  void initState() {
    super.initState();
    futureFiles = FirebaseStorage.instance.ref('/Volunteersfiles').listAll();
    getProfilePicture();
    futureUserDoc =
...
final filtered = snap.where((d) {
  ...
  final ciudadania = data['Volunteer']?.toString().trim();
