...
class ProfeCosturastudents extends StatefulWidget {
  const ProfeCosturastudents({super.key});
  @override
  State<ProfeCosturastudents> createState() => _ProfeCosturastudentsState();
}

class _ProfeCosturastudentsState extends State<ProfeCosturastudents> {
  final currentUser = FirebaseAuth.instance.currentUser!;
  CollectionReference users = FirebaseFirestore.instance.collection('postsCostura');
  ...
  Future uploadFile() async {
    final path = 'Costurafiles/${pickedFile!.name}';
  ...
  void initState() {
    ...
    getProfilePicture();
    futureUserDoc =
        FirebaseFirestore.instance.collection('clases').doc('Costura').get();
    futureUsers = FirebaseFirestore.instance
        .collection('users')
        .orderBy('name', descending: false)
        .get();
...
final filtered = snap.where((d) {
  ...
  final ciudadania = data['costuraAM']?.toString().trim();
