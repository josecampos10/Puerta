...
class _ProfeCosturafilesAMState extends State<ProfeCosturafilesAM> {
  ...
  Future<void> uploadFile() async {
    ...
    final folderRef = FirebaseStorage.instance.ref().child('Costurafiles');
    ...
    final path = 'Costurafiles/$finalName';
  ...
  Future<List<Reference>> obtenerArchivosOrdenados() async {
    final result = await FirebaseStorage.instance.ref('/Costurafiles').listAll();
