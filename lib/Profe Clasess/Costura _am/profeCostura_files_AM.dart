                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    GestureDetector(
                                        child: CircleAvatar(
                                          backgroundColor: const Color.fromARGB(0, 135, 228, 168),
                                          child: Icon(
                                            Icons.upload,
                ...
                child: Column(
                  children: [
                    FutureBuilder<ListResult>(
                      future: FirebaseStorage.instance.ref('/Costurafiles').listAll(),
                                                            ...
                                                            TextButton(
                                                                onPressed: () {
                                                                  FirebaseStorage
                                                                      ...
                                                                      .listAll();
                                                                  setState(() {
                                                                    FirebaseStorage.instance.ref().child('Costurafiles/${file.name}')
                                                                        .delete();
                                                                  });
