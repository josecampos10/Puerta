...
import 'package:lapuerta2/detalles_image.dart'; // <-- detalle con zoom/carrusel
import 'package:url_launcher/url_launcher.dart';
import 'package:easy_localization/easy_localization.dart' as ez;

class Profeeslam extends StatefulWidget {
  const Profeeslam({super.key});
  @override
  State<Profeeslam> createState() => _ProfeeslamState();
}

class _ProfeeslamState extends State<Profeeslam> {
  ...
  // ==== NUEVO: Imágenes y progreso ====
  final ImagePicker _picker = ImagePicker();
  List<XFile> _selectedImages = [];
  bool _isPosting = false;
  List<double> _uploadProgress = []; // 0..1
  ...
  Future<List<String>> _uploadImagesWithProgress(String postId) async {
    ...
    for (int i = 0; i < _selectedImages.length; i++) {
      try {
        ...
        final ref = storage.ref().child('class_media/ESLam/$postId/$fileName');
  ...
  Widget build(BuildContext context) {
    ...
    final composerH = size.height * 0.06; // barra de input
    final previewH  = size.height * 0.10; // alto preview
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          IconButton(
                                            onPressed: () => Navigator.pushNamed(context, '/profeESLam_files'),
                                            icon: Icon(Icons.folder, color: Colors.white, size: size.height * 0.03),
                                          ),
                                          IconButton(
                                            onPressed: () => Navigator.pushNamed(context, '/studentESLam_students'),
                              ...
                              child: Align(
                                ...
                                child: MasonryGridView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    final List<String> images = (dataMap['images'] as List?)
                                            ?.map((e) => e.toString())
                                            .toList() ??
                                        const [];
                                                                  ...
                                                                  onPressed: () async {
                                                                    ...
                                                                    try {
                                                                      ...
                                                                      await FirebaseFirestore.instance
                                                                        ...
                                                                        'storagePath': 'class_media/ESLam/$postId/',
