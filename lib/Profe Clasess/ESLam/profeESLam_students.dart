...
class Profeeslstudentsam extends StatefulWidget {
  const Profeeslstudentsam({super.key});
  @override
  State<Profeeslstudentsam> createState() => _ProfeeslstudentsamState();
}

class _ProfeeslstudentsamState extends State<Profeeslstudentsam> {
  ...
  Future uploadFile() async {
    final path = 'ESLfilesam/${pickedFile!.name}';
...
final filtered = snap.where((d) {
  ...
  final ciudadania = data['ESLam']?.toString().trim();
