...
import 'package:lapuerta2/detalles_image.dart'; // 👈 para ImageDetallesHome (múltiples imágenes)
...
class _ProfeeslpmState extends State<Profeeslpm> {
  ...
  // Colecciones / streams
  final CollectionReference users = FirebaseFirestore.instance.collection('postsESL');
  ...
  List<double> _uploadProgress = []; // 0..1 por imagen
  ...
  Future<List<String>> _uploadImagesWithProgress(String postId) async {
    ...
    for (int i = 0; i < _selectedImages.length; i++) {
      try {
        ...
        final ref = storage.ref().child('class_media/ESLpm/$postId/$fileName'); // 👈 ruta para ESLpm
  ...
  void initState() {
    ...
    getProfilePicture();
    futureUserDoc = FirebaseFirestore.instance.collection('clases').doc('esl 1').get();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final composerH = size.height * 0.06; // altura del input
    final previewH  = size.height * 0.10; // altura del preview
            ...
            Positioned.fill(
              child: Container(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      // ---- Cabecera clase (centrado + botones a la derecha) ----
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          IconButton(
                                            onPressed: () => Navigator.pushNamed(context, '/profeESLpm_files'),
                                            icon: Icon(Icons.folder, color: Colors.white, size: size.height * 0.03),
                                          ),
                                          IconButton(
                                            onPressed: () => Navigator.pushNamed(context, '/studentESLpm_students'),
                                ...
                                child: MasonryGridView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    final List<String> images =
                                        (dataMap['images'] as List?)?.map((e) => e.toString()).toList() ?? const [];
                                                                  ...
                                                                  Navigator.push(
                                                                    ...
                                                                    PageRouteBuilder(
                                                                      ...
                                                                      pageBuilder: (_, __, ___) => ImageDetallesHome(
                                                                        ...
                                                                        images: images,      // 👈 pásale todas
                                                                        initialIndex: 0,     // 👈 abre la primera
                                                                        heroTagPrefix: 'post_${doc.id}_img',
                                                                      ),
                                                                    ),
                                                                  );
                                                                },
                                                                        ...
                                                                        Navigator.push(
                                                                          ...
                                                                          PageRouteBuilder(
                                                                            ...
                                                                            pageBuilder: (_, __, ___) => ImageDetallesHome(
                                                                              ...
                                                                              initialIndex: idx,     // 👈 abre en la tocada
                                                                              heroTagPrefix: 'post_${doc.id}_img',
                                                                            ),
                                                                          ),
                                                                        );
                                                                  ...
                                                                  onPressed: () async {
                                                                    ...
                                                                    try {
                                                                      ...
                                                                      await FirebaseFirestore.instance
                                                                        ...
                                                                        'storagePath': 'class_media/ESLpm/$postId/',
                                                                        'Image': snapUser.data.toString(), // avatar/url del usuario
                                                                        'createdAt': Timestamp.now(),
                                                                      });

                                                                      // 3) Estado global (para avisar nuevo post)
                                                                      await FirebaseFirestore.instance
  ...
  // ===== Foto de perfil (circle avatar appbar) =====
