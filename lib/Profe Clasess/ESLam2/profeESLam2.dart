...
class Profeeslam2 extends StatefulWidget {
  const Profeeslam2({super.key});
  @override
  State<Profeeslam2> createState() => _Profeeslam2State();
}

class _Profeeslam2State extends State<Profeeslam2> {
  ...
  Future<List<String>> _uploadImagesWithProgress(String postId) async {
    ...
    for (int i = 0; i < _selectedImages.length; i++) {
      try {
        ...
        final ref = storage.ref().child('class_media/ESLam2/$postId/$fileName');
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          IconButton(
                                            onPressed: () => Navigator.pushNamed(context, '/profeESLam2_files'),
                                            icon: Icon(Icons.folder, color: Colors.white, size: size.height * 0.03),
                                            tooltip: 'Archivos',
                                          ),
                                          IconButton(
                                            onPressed: () => Navigator.pushNamed(context, '/studentESLam2_students'),
                                                                  ...
                                                                  onPressed: () async {
                                                                    ...
                                                                    try {
                                                                      ...
                                                                      await FirebaseFirestore.instance
                                                                        ...
                                                                        'storagePath': 'class_media/ESLam2/$postId/',
