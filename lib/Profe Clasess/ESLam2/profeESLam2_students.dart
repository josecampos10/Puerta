...
class Profeeslstudentsam2 extends StatefulWidget {
  const Profeeslstudentsam2({super.key});
  @override
  State<Profeeslstudentsam2> createState() => _Profeeslstudentsam2State();
}

class _Profeeslstudentsam2State extends State<Profeeslstudentsam2> {
  ...
  Future uploadFile() async {
    final path = 'ESLfilesam2/${pickedFile!.name}';
  ...
  void initState() {
    super.initState();
    futureFiles = FirebaseStorage.instance.ref('/ESLfilesam2').listAll();
    getProfilePicture();
    futureUserDoc =
...
final filtered = snap.where((d) {
  ...
  final ciudadania = data['ESLam2']?.toString().trim();
