...
class Profeeslfilesam2 extends StatefulWidget {
  const Profeeslfilesam2({super.key});
  @override
  State<Profeeslfilesam2> createState() => _Profeeslfilesam2State();
}

class _Profeeslfilesam2State extends State<Profeeslfilesam2> {
  ...
  Future<void> uploadFile() async {
    ...
    final folderRef = FirebaseStorage.instance.ref().child('ESLfilesam2');
    ...
    final path = 'ESLfilesam2/$finalName';
  ...
  Future<List<Reference>> obtenerArchivosOrdenados() async {
    final result = await FirebaseStorage.instance.ref('/ESLfilesam2').listAll();
