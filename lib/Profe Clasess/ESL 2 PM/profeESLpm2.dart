...
class _Profeeslpm2State extends State<Profeeslpm2> {
  ...
  Future<List<String>> _uploadImagesWithProgress(String postId) async {
    ...
    for (int i = 0; i < _selectedImages.length; i++) {
      try {
        ...
        final ref = storage.ref().child('class_media/ESLpm2/$postId/$fileName');
  ...
  void initState() {
    ...
    getProfilePicture();
    futureUserDoc = FirebaseFirestore.instance.collection('clases').doc('eel 2').get();
  }
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          IconButton(
                                            onPressed: () => Navigator.pushNamed(context, '/profeESLpm2_files'),
                                            icon: Icon(Icons.folder, color: Colors.white, size: size.height * 0.03),
                                          ),
                                          IconButton(
                                            onPressed: () => Navigator.pushNamed(context, '/studentESLpm2_students'),
                                                                ...
                                                                actions: [
                                                                  TextButton(
                                                                    onPressed: () async {
                                                                      ...
                                                                      // Opcional: estado por usuario (corrigiendo el nombre)
                                                                      await FirebaseFirestore.instance
                                                                          .collection('users')
                                                                          .doc(currentUser.email)
                                                                          .collection('postsESLpm2_State')
                                                                          .doc('State')
                                                                          .set({'lastpost': ''});
                                                                  ...
                                                                  onPressed: () async {
                                                                    ...
                                                                    try {
                                                                      ...
                                                                      await FirebaseFirestore.instance
                                                                        ...
                                                                        'storagePath': 'class_media/ESLpm2/$postId/',
