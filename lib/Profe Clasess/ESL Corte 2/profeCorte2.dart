    ...
    textSelectionTheme: TextSelectionThemeData(
      ...
      cursorColor: Theme.of(context).colorScheme.secondary,
              ...
              Container(
                ...
                child: TextButton(
                    onPressed: () =>
                        Navigator.pushNamed(context, '/profeCorte2_files'),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        SizedBox(
              ...
              Container(
                ...
                child: TextButton(
                    onPressed: () =>
                        Navigator.pushNamed(context, '/profeCorte2_students'),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        SizedBox(
                                                                    ...
                                                                    return AlertDialog(
                                                                      ...
                                                                      actions: [
                                                                        TextButton(
                                                                            onPressed:
                                                                                () {
                                                                              FirebaseFirestore.instance.collection('postsCorte2').doc(snapshot.data!.docs[index].id).delete();
                                                                              FirebaseFirestore.instance.collection('users').doc(currentUser.email).collection('postsCorte2_State').doc('State').set({
                                                                                'lastpost': ''
                                                                              });
                                                                              Navigator.of(context).pop();
                                                                            },
