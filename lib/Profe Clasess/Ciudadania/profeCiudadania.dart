  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        bottomOpacity: 0.0,
        toolbarHeight: size.height * 0.09, // compacto como Corte2
            ...
            Positioned.fill(
              child: Container(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      // ---- Header de clase (0.10 alto, con acciones a la derecha) ----
