...
class _ProfeCiudadaniafilesState extends State<ProfeCiudadaniafiles> {
  ...
  Future<void> uploadFile() async {
    ...
    final folderRef = FirebaseStorage.instance.ref().child('Ciudadaniafiles');
    ...
    final path = 'Ciudadaniafiles/$finalName';
  ...
  Future<List<Reference>> obtenerArchivosOrdenados() async {
    final result = await FirebaseStorage.instance.ref('/Ciudadaniafiles').listAll();
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      setState(
                                                                        ...
                                                                        FirebaseStorage
                                                                            .instance
                                                                            .ref()
                                                                            .child('Ciudadaniafiles/${file.name}')
                                                                            .delete();
                                                                      });
