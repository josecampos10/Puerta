...
class Profegedstudentsam2 extends StatefulWidget {
  const Profegedstudentsam2({super.key});
  @override
  State<Profegedstudentsam2> createState() => _Profegedstudentsam2State();
}

class _Profegedstudentsam2State extends State<Profegedstudentsam2> {
  final currentUser = FirebaseAuth.instance.currentUser!;
  CollectionReference users = FirebaseFirestore.instance.collection('postsGEDam2');
  ...
  Future uploadFile() async {
    final path = 'GEDfilesam2/${pickedFile!.name}';
  ...
  void initState() {
    super.initState();
    futureFiles = FirebaseStorage.instance.ref('/GEDfilesam2').listAll();
    getProfilePicture();
    futureUserDoc =
        FirebaseFirestore.instance.collection('clases').doc('GEDam2').get();
    futureUsers = FirebaseFirestore.instance
        .collection('users')
        .orderBy('name', descending: false)
        .get();
...
final filtered = snap.where((d) {
  ...
  final ciudadania = data['GEDam2']?.toString().trim();
