...
class Profegedfilesam2 extends StatefulWidget {
  const Profegedfilesam2({super.key});
  @override
  State<Profegedfilesam2> createState() => _Profegedfilesam2State();
}

class _Profegedfilesam2State extends State<Profegedfilesam2> {
  ...
  Future<void> uploadFile() async {
    ...
    final folderRef = FirebaseStorage.instance.ref().child('GEDfilesam2');
    ...
    final path = 'GEDfilesam2/$finalName';
  ...
  Future<List<Reference>> obtenerArchivosOrdenados() async {
    final result = await FirebaseStorage.instance.ref('/GEDfilesam2').listAll();
