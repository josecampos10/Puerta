...
class Profegedam2 extends StatefulWidget {
  const Profegedam2({super.key});
  @override
  State<Profegedam2> createState() => _Profegedam2State();
}

class _Profegedam2State extends State<Profegedam2> {
  ...
  Future<List<String>> _uploadImagesWithProgress(String postId) async {
    ...
    for (int i = 0; i < _selectedImages.length; i++) {
      try {
        ...
        final ref = storage.ref().child('class_media/GEDam2/$postId/$fileName');
  ...
  void initState() {
    ...
    getProfilePicture();
    futureUserDoc = FirebaseFirestore.instance.collection('clases').doc('GEDam2').get();
  }
            ...
            Positioned.fill(
              child: Container(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      // ---- Cabecera de clase (igual que Corte2) ----
                      FutureBuilder<DocumentSnapshot>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          return Align(
                            ...
                            child: Container(
                              width: size.width,
                              height: size.height * 0.10, // 👈 reducido como Corte2
                              decoration: BoxDecoration(
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          IconButton(
                                            onPressed: () => Navigator.pushNamed(context, '/profeGEDam2_files'),
                                            icon: Icon(Icons.folder, color: Colors.white, size: size.height * 0.03),
                                          ),
                                          IconButton(
                                            onPressed: () => Navigator.pushNamed(context, '/profeGEDam2_students'),
                                                    ...
                                                    Row(
                                                      children: [
                                                        ...
                                                        Align(
                                                          ...
                                                          child: Text(
                                                            dataMap['User'] ?? dataMap['Name'] ?? 'Usuario',
                                                            style: TextStyle(
                                                              fontSize: size.height * 0.018,
                                                              fontFamily: 'Arial',
                                                              fontWeight: FontWeight.bold,
                                                                  ...
                                                                  onPressed: () async {
                                                                    ...
                                                                    try {
                                                                      ...
                                                                      await FirebaseFirestore.instance
                                                                        ...
                                                                        'storagePath': 'class_media/GEDam2/$postId/',
