...
class _Profegedam2State extends State<Profegedam2> {
  ...
  CollectionReference users =
      FirebaseFirestore.instance.collection('postsGEDam2');
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: TextButton(
                    onPressed: () =>
                        Navigator.pushNamed(context, '/profeGEDam2_files'),
                    child: Row(
              ...
              Container(
                ...
                child: TextButton(
                    onPressed: () =>
                        Navigator.pushNamed(context, '/profeGEDam2_students'),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        SizedBox(
                                                                    ...
                                                                    return AlertDialog(
                                                                      ...
                                                                      actions: [
                                                                        TextButton(
                                                                            onPressed:
                                                                                () {
                                                                              FirebaseFirestore.instance.collection('postsGEDam2').doc(snapshot.data!.docs[index].id).delete();
                                                                              FirebaseFirestore.instance.collection('users').doc(currentUser.email).collection('postsGEDam2_State').doc('State').set({
                                                                                'lastpost': ''
                                                                              });
