...
class Profechickfiles extends StatefulWidget {
  const Profechickfiles({super.key});
  @override
  State<Profechickfiles> createState() => _ProfechickfilesState();
}

class _ProfechickfilesState extends State<Profechickfiles> {
  ...
  Future<void> uploadFile() async {
    ...
    final folderRef = FirebaseStorage.instance.ref().child('chickfiles');
    ...
    final path = 'chickfiles/$finalName';
  ...
  Future<List<Reference>> obtenerArchivosOrdenados() async {
    final result = await FirebaseStorage.instance.ref('/chickfiles').listAll();
