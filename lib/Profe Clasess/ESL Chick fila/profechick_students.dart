...
class Profechickstudents extends StatefulWidget {
  const Profechickstudents({super.key});
  @override
  State<Profechickstudents> createState() => _ProfechickstudentsState();
}

class _ProfechickstudentsState extends State<Profechickstudents> {
  final currentUser = FirebaseAuth.instance.currentUser!;
  CollectionReference users = FirebaseFirestore.instance.collection('postschick');
  ...
  Future uploadFile() async {
    final path = 'chickfiles/${pickedFile!.name}';
  ...
  void initState() {
    super.initState();
    futureFiles = FirebaseStorage.instance.ref('/chickfiles').listAll();
    getProfilePicture();
    futureUserDoc =
        FirebaseFirestore.instance.collection('clases').doc('esl chick').get();
    futureUsers = FirebaseFirestore.instance
        .collection('users')
        .orderBy('name', descending: false)
        .get();
...
final filtered = snap.where((d) {
  ...
  final ciudadania = data['ESLchick']?.toString().trim();
