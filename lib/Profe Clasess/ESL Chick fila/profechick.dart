...
class Profechick extends StatefulWidget {
  ...
  @override
  State<Profechick> createState() => _ProfechickState();
}

class _ProfechickState extends State<Profechick> {
  final currentUser = FirebaseAuth.instance.currentUser!;
  final usuario = FirebaseFirestore.instance.collection('users').doc().snapshots();

  // Colección de posts de esta clase
  final CollectionReference users = FirebaseFirestore.instance.collection('postschick');

  final controller = TextEditingController();

  final streaming = FirebaseFirestore.instance
      .collection('postschick')
  ...
  // Subida de imágenes con progreso a Storage
  Future<List<String>> _uploadImagesWithProgress(String postId) async {
    ...
    for (int i = 0; i < _selectedImages.length; i++) {
      try {
        ...
        final ref = storage.ref().child('class_media/ESLchick/$postId/$fileName');
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                image: const DecorationImage(
                                  ...
                                  image: AssetImage('assets/img/ESLchick.png'),
                                  fit: BoxFit.cover,
                                ),
                                borderRadius: BorderRadius.only(
                                  topLeft: Radius.circular(size.width * 0.087),
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          IconButton(
                                            onPressed: () => Navigator.pushNamed(context, '/profechick_files'),
                                            icon: Icon(Icons.folder, color: Colors.white, size: size.height * 0.03),
                                          ),
                                          IconButton(
                                            onPressed: () => Navigator.pushNamed(context, '/studentchick_students'),
                                                                  ...
                                                                  onPressed: () async {
                                                                    ...
                                                                    try {
                                                                      ...
                                                                      await FirebaseFirestore.instance
                                                                        ...
                                                                        'storagePath': 'class_media/ESLchick/$postId/',
