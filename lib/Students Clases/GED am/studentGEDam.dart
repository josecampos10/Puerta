...
class Studentgedam extends StatefulWidget {
  const Studentgedam({super.key});
  @override
  State<Studentgedam> createState() => _StudentgedamState();
}

class _StudentgedamState extends State<Studentgedam> {
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: TextButton(
                    onPressed: () =>
                        Navigator.pushNamed(context, '/studentGEDam_files'),
                    child: Row(
                    ...
                    child: SizedBox(
                      ...
                      child: images.length == 1
                          ...
                          ? GestureDetector(
                              ...
                              child: Hero(
                                tag: 'student_GEDam_post_${doc.id}_img_0',
                                child: Image.network(
                                  images.first,
                                  fit: BoxFit.cover,
                                ),
                              ...
                              itemBuilder: (_, idx) {
                                ...
                                return Padding(
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Hero(
                                      tag:
                                          'student_GEDam_post_${doc.id}_img_$idx',
                                      child: Image.network(
                                        url,
                                        fit: BoxFit.cover,
                                      ),
