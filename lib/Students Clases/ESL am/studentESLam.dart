...
class Studenteslam extends StatefulWidget {
  const Studenteslam({super.key});
  @override
  State<Studenteslam> createState() => _StudenteslamState();
}

class _StudenteslamState extends State<Studenteslam> {
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: TextButton(
                    onPressed: () =>
                        Navigator.pushNamed(context, '/studentESLam_files'),
                    child: Row(
                    ...
                    child: SizedBox(
                      ...
                      child: images.length == 1
                          ...
                          ? GestureDetector(
                              ...
                              child: Hero(
                                tag: 'student_ESLam_post_${doc.id}_img_0',
                                child: Image.network(
                                  images.first,
                                  fit: BoxFit.cover,
                                ),
                              ...
                              itemBuilder: (_, idx) {
                                ...
                                return Padding(
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Hero(
                                      tag:
                                          'student_ESLam_post_${doc.id}_img_$idx',
                                      child: Image.network(
                                        url,
                                        fit: BoxFit.cover,
                                      ),
