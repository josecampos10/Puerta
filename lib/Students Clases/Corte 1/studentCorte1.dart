...
class StudentCorte1 extends StatefulWidget {
  const StudentCorte1({super.key});
  @override
  State<StudentCorte1> createState() => _StudentCorte1State();
}

class _StudentCorte1State extends State<StudentCorte1> {
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: TextButton(
                    onPressed: () =>
                        Navigator.pushNamed(context, '/studentCorte1_files'),
                    child: Row(
