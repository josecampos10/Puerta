...
class Studentgedam2 extends StatefulWidget {
  const Studentgedam2({super.key});
  @override
  State<Studentgedam2> createState() => _Studentgedam2State();
}

class _Studentgedam2State extends State<Studentgedam2> {
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: TextButton(
                    onPressed: () =>
                        Navigator.pushNamed(context, '/studentGEDam2_files'),
                    child: Row(
                    ...
                    child: SizedBox(
                      ...
                      child: images.length == 1
                          ...
                          ? GestureDetector(
                              ...
                              child: Hero(
                                tag: 'student_GEDam2_post_${doc.id}_img_0',
                                child: Image.network(
                                  images.first,
                                  fit: BoxFit.cover,
                                ),
                              ...
                              itemBuilder: (_, idx) {
                                ...
                                return Padding(
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Hero(
                                      tag:
                                          'student_GEDam2_post_${doc.id}_img_$idx',
                                      child: Image.network(
                                        url,
                                        fit: BoxFit.cover,
                                      ),
