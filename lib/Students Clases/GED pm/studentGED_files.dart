...
class Studentgedfilespm extends StatefulWidget {
  const Studentgedfilespm({Key? key}) : super(key: key);
  @override
                ...
                child: Column(
                  children: [
                    FutureBuilder<ListResult>(
                      future:
                          FirebaseStorage.instance.ref('/GEDfiles').listAll(),
                                  ...
                                  return Container(
                                    ...
                                    child: ListTile(
                                      ...
                                      trailing: IconButton(
                                          ...
                                          icon: Icon(
                                            Icons.download,
                                            size: size.height * 0.03,color: const Color.fromARGB(255, 5, 146, 189),
                                          )),
                                    ),
                                  );
                                }),
