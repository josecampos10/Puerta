...
class Studentgedfilespm extends StatefulWidget {
  const Studentgedfilespm({super.key});
  @override
  State<Studentgedfilespm> createState() => _StudentgedfilespmState();
}

class _StudentgedfilespmState extends State<Studentgedfilespm> {
  ...
  Future<void> uploadFile() async {
    ...
    final folderRef = FirebaseStorage.instance.ref().child('GEDfiles');
  ...
  Future<List<Reference>> obtenerArchivosOrdenados() async {
    final result = await FirebaseStorage.instance.ref('/GEDfiles').listAll();
