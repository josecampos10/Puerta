...
class StudentCorte2 extends StatefulWidget {
  const StudentCorte2({super.key});
  @override
  State<StudentCorte2> createState() => _StudentCorte2State();
}

class _StudentCorte2State extends State<StudentCorte2> {
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: TextButton(
                    onPressed: () =>
                        Navigator.pushNamed(context, '/studentCorte2_files'),
                    child: Row(
                    ...
                    child: SizedBox(
                      ...
                      child: images.length == 1
                          ...
                          ? GestureDetector(
                              ...
                              child: Hero(
                                tag: 'student_corte2_post_${doc.id}_img_0',
                                child: Image.network(
                                  images.first,
                                  fit: BoxFit.cover,
                                ),
                              ...
                              itemBuilder: (_, idx) {
                                ...
                                return Padding(
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Hero(
                                      tag:
                                          'student_corte2_post_${doc.id}_img_$idx',
                                      child: Image.network(
                                        url,
                                        fit: BoxFit.cover,
                                      ),
