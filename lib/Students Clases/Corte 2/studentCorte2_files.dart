...
class Studentfilescorte2 extends StatefulWidget {
  const Studentfilescorte2({super.key});
  @override
  State<Studentfilescorte2> createState() => _Studentfilescorte2State();
}

class _Studentfilescorte2State extends State<Studentfilescorte2> {
  ...
  Future<void> uploadFile() async {
    ...
    final folderRef = FirebaseStorage.instance.ref().child('Corte2files');
    ...
    final path = 'Corte2files/$finalName';
  ...
  Future<List<Reference>> obtenerArchivosOrdenados() async {
    final result = await FirebaseStorage.instance.ref('/Corte2files').listAll();
